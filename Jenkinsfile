pipeline {
    ...
    environment {
        SNYK_TOKEN = credentials('4969d507-8c07-4fe6-b2ef-f48578939f98')// Store your Snyk token in Jenkins credentials
    }
    ...
    steps {
        script {
            ...
            withCredentials([string(credentialsId: '4969d507-8c07-4fe6-b2ef-f48578939f98', variable: 'SNYK_TOKEN')]) {
